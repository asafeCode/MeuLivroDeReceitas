...
public class RecipeValidatorTest
{
    ...
    [Fact]
    public void Error_CookingTime_Not_Supported()
    {
        var validator = new RecipeValidator();

        var request = RequestRecipeJsonBuilder.Build();
        request.CookingTime = (ComCookingTime?)1000;
    ...
    [Fact]
    public void Error_Difficulty_Not_Supported()
    {
        var validator = new RecipeValidator();

        var request = RequestRecipeJsonBuilder.Build();
        request.Difficulty = (ComDifficulty?)1000; ;
    ...
    {
        var request = RequestRecipeJsonBuilder.Build();
        request.DishTypes.Add((ComDishType)1000);
